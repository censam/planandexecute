    ...
    <div class="max-w-screen-xl px-3 py-2 mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-wrap items-center justify-between">
            <div class="flex items-center flex-1 w-0 min-w-0">
                ...
                <p class="text-sm font-medium font-semibold text-white truncate ml-36" x-text="message"></p>
            </div>
            ...
            <div class="flex-shrink-0 sm:ml-3">
                <button
                    ...
                    :class="{ 'hover:bg-green-500 focus:bg-green-500': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                    aria-label="Dismiss"
